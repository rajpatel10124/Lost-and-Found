<?php
// This is a duplicate file with a different name in case of case sensitivity issues
session_start();
...
<body>
    ...
    <div class="container">
        ...
        <?php elseif (!$confirm): ?>
            ...
            <p>
                <a href="DeleteItem.php?type=<?php echo $type; ?>&id=<?php echo $id; ?>&confirm=yes" class="btn btn-danger">Yes, Delete Item</a>
